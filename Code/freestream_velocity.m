...
for i = 1:11
    ...
    d_v_inf_scanivalve(i) = 1/2 * sqrt((d_p_scani(i)/(2*v_inf_scanivalve(i)*RHO))^2 + (d_p_scani(i)/(2*v_inf_scanivalve(i)*RHO))^2);
    ...
    d_v_inf_manometer(i) = 1/2 * sqrt((d_combined_rakes_manometer(1)/(2*v_inf_manometer(i)*RHO))^2 ...
