...
\noindent
The shape of the $C_L$ vs $\alpha$ plot in figure \ref{fig:coeffs} agrees well with the reference experiment in terms of stall angle, as well as the plateau behaviour around 10 degrees. Additionally, the experimentally derrived $C_L$ vs $C_D$ plots take on a similar form as the corresponding plot in the literature as seen in figure \ref{fig:reference_cl_cd} albeit of a slightly different order or magnitude.
