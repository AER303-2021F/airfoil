...
\noindent
<<<<<<< HEAD
The shape of the $C_L$ vs $\alpha$ plot in Figure \ref{fig:coeffs} agrees well with the reference experiment in terms of stall angle, as well as the plateau behaviour around 10 degrees. Additionally, the experimental $C_L$ vs $C_D$ curves as seen in figure \ref{fig:cL_vs_cD} follow the same general shape as that seen in \ref{fig:reference_cl_cd}.
=======
...
>>>>>>> 8de78a9cc53561c2df5c675f389ee277635f1c98
