...
The drag force formulation from above ignore viscous effects, because this experiment cannot directly measure the shear force distribution over the surface of the airfoil. Instead, total drag calculation is performed by performing a momentum balance in a control volume containing the airfoil.
\begin{align*}
...
Wake velocities are obtained from total pressure measurements in the wake to determine the flow velocity distribution over the height of the pressure rake.
\begin{figure}
    \centering
